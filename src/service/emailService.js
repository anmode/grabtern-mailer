...
module.exports = async function sendEmail(
  ...
  try {
    ...
    const headerPath = path.join(templatesPath, "header.html");
    const footerPath = path.join(templatesPath, "footer.html");
    ...
    return { message: "Error in sending Mail", error: error };
  }
};
